 ...
 */
public class LockedRecordingList<T> {
    ...
    public boolean contains(T x) {
        ...
        recorder.addSample(linearizationTime, 0, x, (curr.key == v));
        return (curr.key == v);
    }
